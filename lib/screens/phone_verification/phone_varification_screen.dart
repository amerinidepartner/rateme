...
import 'package:rate_me/screens/phone_verification/Widget.dart';
import 'package:rate_me/screens/phone_verification/phone_verificetion_controller.dart';
...
class PhoneVerificationScreen extends StatelessWidget {
  bool isCheck;
  PhoneVerificationScreen({required this.isCheck,super.key});
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage(AssetRes.phoneBg,),fit: BoxFit.cover,)
            ),
          ),
          Padding(
                              ...
                              Card(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    //     phoneNumber: '+91 8849 660 448',
                                    //     verificationCompleted: (PhoneAuthCredential credential) {},
                                    //     verificationFailed: (FirebaseAuthException e) {},
                                    //     codeSent: (String verificationId, int? resendToken) {
                                    //       contoller.verify = verificationId;
                                    //       Get.to(()=> OtpScreen(isCheck: isCheck,));
                                    //     },
                                    //     codeAutoRetrievalTimeout: (String verificationId) {},
                                    //   );
                                     if(contoller.phoneController.text.isEmpty){
                                       contoller.isValidate = false;
                                     }
                                     else{
                                       contoller.isValidate = true;
